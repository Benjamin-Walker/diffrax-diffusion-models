...
class ResnetBlock(eqx.Module):
    ...
    block2_layers: List[
        Union[eqx.nn.GroupNorm, eqx.nn.Dropout, eqx.nn.Conv2d, FunctionType]
    ]
...
class UNet(eqx.Module):
    ...
    final_conv_layers: List[Union[eqx.nn.LayerNorm, eqx.nn.Conv2d]]
    ...
    def __init__(
        ...
        *,
        ...
        self.first_conv = eqx.nn.Conv2d(
            in_channels, hidden_size, kernel_size=3, padding=1, key=keys[1]
        )
